...
  }, [history, historyIndex, isEditable]);
  
  // MODIFICATION: Now automatically focuses the first editable cell after adding a row.
              ...
              <tr>
                ...
                >
                  <button 
                      ...
                      className="p-1.5 rounded-md bg-indigo-500 text-white hover:bg-indigo-600 flex items-center gap-1.5 text-xs"
                      title="Add New Row"
                  >
